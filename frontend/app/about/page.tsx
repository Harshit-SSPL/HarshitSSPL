...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col gap-0 bg-white dark:bg-black text-slate-900 dark:text-white min-h-screen transition-colors duration-300">
      ...
      {/* ============================================================ */}
      {/* 6.5 DIRECTOR / LEADERSHIP VISION SECTION (NEW SECTION) */}
      {/* ============================================================ */}
      <motion.section
        className="py-12 md:py-16 bg-black text-white border-b border-zinc-900 transition-colors relative overflow-hidden"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false, amount: 0.15 }}
        variants={sectionVariants}
      >
        ...
        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-ssil-red/10 blur-[120px] pointer-events-none rounded-full" />
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <motion.span
                variants={childVariants}
                className="text-xs sm:text-sm font-extrabold uppercase tracking-widest text-slate-300 block mb-3"
              >
              ...
              <motion.h2
                variants={childVariants}
                className="text-2xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-[1.15] mb-5"
              >
                Lighting the way forward,<br />
                with infrastructure <span className="text-ssil-red">built to last.</span>
              </motion.h2>

              {/* Director Identity Badge */}
              <motion.div variants={childVariants} className="mb-6 flex items-center gap-3">
                <div className="h-10 w-1 bg-ssil-red rounded-full shrink-0" />
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight">
                    Ashok Kumar Sharma
                  </h3>
                  <p className="text-xs sm:text-sm font-semibold text-slate-400">
                    Director · Shiv Shakti India Limited
                  </p>
                </div>
              </motion.div>

              {/* Short Director Leadership Message (Concise ~90 words) */}
              <motion.p
                variants={childVariants}
                className="text-sm sm:text-base text-slate-300 font-normal leading-relaxed mb-8 max-w-2xl"
              >
                At Shiv Shakti India Limited, our foundation is built on an uncompromised commitment to engineering integrity and long-term durability. We believe that public and industrial infrastructure lighting demands far more than basic material supply—it requires precise structural calculation, custom manufacturing, and dedicated execution. As we expand across India&apos;s highways, smart cities, and landmark architecture, our focus remains steadfast on creating reliable, energy-efficient solutions designed to perform flawlessly for decades to come.
              </motion.p>

              {/* 3 Compact Leadership Principles */}
              <motion.div variants={childVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-zinc-800/80">
                <div className="flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="h-2 w-2 rounded-full bg-ssil-red shrink-0" />
                    <h4 className="text-xs font-black uppercase text-white tracking-wider">
                      Engineered with Purpose
                    </h4>
                  </div>
                  <p className="text-xs text-slate-400 font-normal leading-normal">
                    Solutions designed around real project requirements.
                  </p>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs text-slate-400 font-normal leading-normal">
                    Quality and durability remain central to every solution.
                  </p>
                </div>
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="h-2 w-2 rounded-full bg-ssil-red shrink-0" />
                    <h4 className="text-xs font-black uppercase text-white tracking-wider">
                      Partnership over Supply
                    </h4>
                  </div>
                  <p className="text-xs text-slate-400 font-normal leading-normal">
                    Working with clients beyond simply delivering a product.
                  </p>
                </div>
              </motion.div>
            ...
            {/* Right Column: Director Portrait Frame Container (5 cols on lg) */}
            <motion.div variants={childVariants} className="lg:col-span-5 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-none aspect-[4/5] rounded-2xl sm:rounded-3xl overflow-hidden border border-zinc-800 bg-gradient-to-b from-zinc-900 via-zinc-950 to-black shadow-2xl group flex flex-col justify-end p-6 sm:p-8">
                ...
                {/* Director Avatar / Professional Placeholder Graphics */}
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
                  <div className="h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-gradient-to-br from-ssil-red/20 via-zinc-800 to-zinc-900 border border-ssil-red/40 flex items-center justify-center shadow-inner mb-4 group-hover:scale-105 transition-transform duration-500">
                    <UserCheck className="h-12 w-12 sm:h-14 sm:w-14 text-ssil-red" />
                  </div>
                  ...
                  <span className="text-xs font-bold text-ssil-red uppercase tracking-wider mt-1 px-3 py-1 rounded-full bg-ssil-red/10 border border-ssil-red/20">
                    Director &amp; Founder Leadership
                  </span>
                </div>

                {/* Bottom Architectural Gradient Overlay */}
                ...
                <div className="relative z-30 flex items-center justify-between border-t border-zinc-800/80 pt-4">
