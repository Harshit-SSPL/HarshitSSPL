...
const flagMastSpecifications: FlagMastSpecRow[] = [
  {
...
const flagMastBlueprintSpecs: BlueprintTechSpec[] = [
  {
    property: "Structure",
    value: "Monumental Telescopic Polygonal Mast",
  },
  {
    property: "Top Finial / Truck",
    value: "360° Non-Tangling Dual-Pulley Revolving Truck Assembly",
  },
  {
    property: "Hoisting System",
    value: "Internal Motorized Winch / Manual Mechanical Winch Mechanism",
  },
  {
    property: "Halyard Cable",
    value: "Corrosion-Proof Stainless Steel (SS 316) Aircraft Wire Rope",
  },
  {
  ...
  },
  {
    ...
    value: "12M to 50M (Modular Slip-Joint Assembly)",
  },
  {
  ...
  {
    property: "Access Door",
    value: "Flush Vandal-Resistant Inspection Door with Mechanical Lock",
  },
  {
    property: "Base Plate Design",
    value: "Heavy-Duty Flanged Steel Base with Radial Gusset Stiffeners",
  },
  {
  ...
  {
    property: "Aviation Warning Beacon",
    value: "Twin Medium/Low Intensity LED Aviation Warning Beacon",
  },
  {
  ...
  {
    property: "Optional Illumination",
    value: "Ground-Mounted / 360° Floodlight Halo Illuminating Crown",
  },
  {
    property: "Brand",
    value: "SSIL",
...
export default function FlagMastPage() {
  ...
  const openEnquiry = (modelName?: string) => {
    setEnquiryState({
      isOpen: true,
      productCategory: "Flag Mast",
      productModel: modelName || "Standard Monumental Flag Mast Pole (12M–50M)",
    });
  };

  const resilientHero = useResilientImage({
    liveSrc: bannerImage,
    keyOptions: { type: "hero", slug: "flag-mast-poles", variant: "hero" },
  ...
  const resilientDay = useResilientImage({
    liveSrc: dayImage,
    keyOptions: { type: "product", slug: "flag-mast-poles", variant: "day" },
  ...
  const resilientNight = useResilientImage({
    ...
    keyOptions: { type: "product", slug: "flag-mast-poles", variant: "night" },
    placeholderType: "product",
    transformOptions: IMAGE_PRESETS.SHOWCASE.transform,
    responsiveWidths: IMAGE_PRESETS.SHOWCASE.widths,
    sizes: IMAGE_PRESETS.SHOWCASE.sizes,
  ...
  return (
    <div className="relative min-h-screen w-full bg-white dark:bg-black text-slate-900 dark:text-white transition-colors duration-300 overflow-hidden">
                ...
                <div className="space-y-2.5 pt-1 max-w-2xl text-left">
                  <div className="flex items-start gap-2.5">
                    ...
                    <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 font-medium leading-relaxed">
                      SSIL Flag Mast Poles are precision-engineered for national flags, institutional campuses, corporate premises, ceremonial spaces, public landmarks, and other high-visibility installations. Designed for structural stability, corrosion resistance, dependable flag hoisting, and long-term outdoor performance.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-ssil-red shrink-0 mt-2" />
                    <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 font-medium leading-relaxed">
                      Engineered for high-visibility flag installations with robust structural construction, dependable hoisting systems, and weather-resistant protection.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-ssil-red shrink-0 mt-2" />
                    <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 font-medium leading-relaxed">
                      Available in customized heights, configurations, finishes, and accessories to suit national, ceremonial, institutional, municipal, and corporate applications.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start">
            ...
            <motion.div variants={childVariants} className="lg:col-span-5 space-y-2 text-left">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase leading-[1.1]">
                MONUMENTAL FLAG STRUCTURES.<br />
                <span className="text-ssil-red">PRECISION HOISTING &amp; ICONIC PRESENCE.</span>
              </h2>
            ...
            <motion.div variants={childVariants} className="lg:col-span-7 space-y-3 text-left text-slate-700 dark:text-slate-300 leading-relaxed font-normal text-sm sm:text-base">
              <p>
                Shiv Shakti India Limited (SSIL) manufactures monumental Hot-Dip Galvanized Flag Mast Towers designed to elevate national flags, corporate insignia, and institutional emblems across landmark civic plazas, military cantonments, government secretariats, and university campuses.
              </p>
              <p>
                Our flag masts feature precision-engineered 360-degree rotating top truck assemblies with dual stainless steel pulleys that prevent flag tangling under shifting wind directions, paired with heavy-duty internal motorized or manual winch halyard systems for smooth, effortless hoisting and lowering.
              </p>
              <p>
                Engineered to comply with stringent wind-load safety standards (IS 875 Part 3), each modular telescopic polygonal shaft combines architectural grandeur with high-tensile structural stability and multi-decade corrosion immunity.
              </p>
            </motion.div>
      ...
      {/* ============================================================ */}
      {/* 4. DIMENSION SPECIFICATIONS (COMPLETE 12M–50M TECHNICAL DATA SHEET) */}
      {/* ============================================================ */}
      <motion.section
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          <div className="mb-6 pb-4 border-b border-slate-200/90 dark:border-zinc-800/90 text-left">
            <motion.div variants={childVariants} className="max-w-3xl">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase leading-[1.1]">
                FLAG MAST POLE <span className="text-ssil-red">TECHNICAL SPECIFICATIONS.</span>
              </h2>
              <p className="mt-1.5 text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-300 font-normal leading-relaxed max-w-2xl">
                Comprehensive technical parameters across SSIL&apos;s modular Flag Mast portfolio ranging from 12 Meters to 50 Meters in height. Fabricated with high-tensile steel and hot-dip galvanized in-house.
              </p>
            </motion.div>
          </div>

          {/* Full Technical Specifications Table (All 8 Heights Always Visible) */}
          <motion.div
          ...
          >
              ...
              <table className="w-full text-left border-collapse min-w-[940px]">
                <thead>
                  <tr className="bg-slate-900 text-white text-xs font-extrabold uppercase tracking-wider border-b border-slate-800">
                    ...
                    <th className="py-3.5 px-3 sm:px-4 text-center">40 MTR</th>
                    <th className="py-3.5 px-4 sm:px-6 text-center">50 MTR</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 dark:divide-zinc-800 text-xs sm:text-sm font-medium text-slate-800 dark:text-slate-200">
                  {flagMastSpecifications.map((row, idx) => (
                    <tr
                      key={row.parameter}
                  ...
                  <tr className="bg-slate-100/70 dark:bg-zinc-900/60 border-t-2 border-slate-300 dark:border-zinc-700">
                    ...
                    {[
                      { id: "SSILFM01", height: "12M" },
                      { id: "SSILFM02", height: "12.5M" },
                      { id: "SSILFM03", height: "16M" },
                      { id: "SSILFM04", height: "20M" },
                      { id: "SSILFM05", height: "25M" },
                      { id: "SSILFM06", height: "30M" },
                      { id: "SSILFM07", height: "40M" },
                      { id: "SSILFM08", height: "50M" },
                    ].map((item) => (
                      <td key={item.id} className="py-3 px-2 sm:px-3 text-center">
                        <Button
                          size="sm"
                          onClick={() => openEnquiry(`${item.id} (${item.height} Monumental Flag Mast)`)}
            ...
            <div className="p-3.5 bg-slate-50 dark:bg-zinc-900/50 border-t border-slate-200 dark:border-zinc-800 text-left flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-600 dark:text-slate-400">
              <span className="flex items-center gap-1.5">
                ...
                Customized heights, finishes, hoisting systems and accessories available based on project requirements.
              </span>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          <div className="max-w-4xl mb-6 sm:mb-8 text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase leading-[1.1]">
              DRAWING OF <br />
              <span className="text-ssil-red">FLAG MAST POLE.</span>
            </h2>
            <p className="mt-2 text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-300 font-normal leading-relaxed max-w-2xl">
              Structural detailing illustrating the 360° revolving truck finial, internal stainless steel wire rope halyard, modular polygonal shaft, and civil anchor assembly.
            </p>
          </div>
          ...
          >
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
              ...
              {/* Preserved Visual Engineering Schematic Drawing for Flag Mast */}
              <div className="lg:col-span-6 flex items-center justify-center p-5 bg-slate-100/80 dark:bg-black/60 rounded-2xl border border-slate-200 dark:border-zinc-800 h-full min-h-[520px]">
                ...
                >
                  {/* Lightning Finial & 360 Revolving Truck Cap */}
                  <line x1="160" y1="12" x2="160" y2="35" stroke="#ef4444" strokeWidth="2.5" />
                  <circle cx="160" cy="15" r="4" fill="#ef4444" />
                  <text x="175" y="19" fontSize="9" fontWeight="bold" fill="#ef4444">360° Revolving Truck</text>

                  {/* Top Truck Dome / Dual Pulley Cap */}
                  <ellipse cx="160" cy="38" rx="14" ry="7" fill="currentColor" fillOpacity="0.3" stroke="currentColor" strokeWidth="2" />
                  
                  {/* National Flag Graphic Fluttering */}
                  <path
                    d="M160 42 C190 35, 210 50, 245 42 C245 85, 245 85, 245 85 C210 93, 190 78, 160 85 Z"
                    fill="#ef4444"
                    fillOpacity="0.18"
                    stroke="#ef4444"
                    strokeWidth="2"
                  />
                  {/* Flag Internal Stripes & Emblem Indicator */}
                  <path d="M160 56 C190 49, 210 64, 245 56" stroke="#ef4444" strokeWidth="1.2" strokeDasharray="3 2" />
                  <path d="M160 70 C190 63, 210 78, 245 70" stroke="#ef4444" strokeWidth="1.2" strokeDasharray="3 2" />
                  <circle cx="202" cy="63" r="4.5" stroke="#ef4444" strokeWidth="1.2" />

                  <text x="252" y="65" fontSize="9" fontWeight="bold" fill="#ef4444">Monumental Flag</text>

                  {/* Internal SS Wire Rope Halyard Indicator */}
                  <line x1="158" y1="42" x2="158" y2="410" stroke="#ef4444" strokeWidth="1.5" strokeDasharray="4 3" strokeOpacity="0.8" />
                  <text x="75" y="60" fontSize="9" fontWeight="bold" fill="#ef4444">Internal SS Halyard</text>

                  {/* Top Dia Callout */}
                  <line x1="140" y1="100" x2="180" y2="100" stroke="#3b82f6" strokeWidth="2" strokeDasharray="3 3" />
                  <text x="70" y="104" fontSize="10" fontWeight="bold" fill="currentColor">Top Dia (150-200mm)</text>

                  {/* Telescopic Polygonal Mast (Top Section) */}
                  <polygon
                    points="148,100 172,100 178,215 142,215"
                    fill="currentColor"
                    fillOpacity="0.08"
                    stroke="currentColor"
                    strokeWidth="2.5"
                  ...
                  {/* Slip Joint 1 */}
                  <rect x="138" y="211" width="44" height="8" rx="2" fill="currentColor" fillOpacity="0.25" stroke="currentColor" strokeWidth="1.5" />
                  <text x="190" y="218" fontSize="8" fontWeight="bold" fill="#3b82f6">Telescopic Slip Joint</text>

                  {/* Middle Mast Section */}
                  <polygon
                    points="142,219 178,219 188,345 132,345"
                    fill="currentColor"
                    fillOpacity="0.08"
                    stroke="currentColor"
                    strokeWidth="2.5"
                  ...
                  {/* Slip Joint 2 */}
                  <rect x="128" y="341" width="64" height="8" rx="2" fill="currentColor" fillOpacity="0.25" stroke="currentColor" strokeWidth="1.5" />

                  {/* Bottom Mast Section */}
                  <polygon
                    points="132,349 188,349 204,475 116,475"
                    fill="currentColor"
                    fillOpacity="0.08"
                    stroke="currentColor"
                    strokeWidth="2.5"
                  ...
                  <line x1="154" y1="100" x2="142" y2="475" stroke="currentColor" strokeWidth="1" strokeOpacity="0.35" />
                  <line x1="166" y1="100" x2="178" y2="475" stroke="currentColor" strokeWidth="1" strokeOpacity="0.35" />
                  ...
                  <rect
                    ...
                    strokeWidth="2"
                  />
                  <circle cx="160" cy="427" r="3" fill="#ef4444" />
                  <text x="190" y="431" fontSize="9" fontWeight="bold" fill="#ef4444">Winch Gear Door</text>

                  {/* Bottom Dia Callout Indicator */}
                  <line x1="110" y1="475" x2="210" y2="475" stroke="#3b82f6" strokeWidth="2" strokeDasharray="3 3" />
                  <text x="218" y="479" fontSize="10" fontWeight="bold" fill="currentColor">Bottom Dia (360-740mm)</text>

                  {/* Heavy-Duty Base Plate with Radial Stiffeners */}
                  <rect x="100" y="475" width="120" height="18" rx="3" fill="currentColor" fillOpacity="0.25" stroke="currentColor" strokeWidth="2" />
                  <polygon points="116,475 106,475 116,442" fill="currentColor" fillOpacity="0.3" />
                  <polygon points="204,475 214,475 204,442" fill="currentColor" fillOpacity="0.3" />

                  {/* High-Tensile J-Bolts Foundation Assembly */}
                  <path d="M110 493 L110 548 L98 548" stroke="#10b981" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M210 493 L210 548 L222 548" stroke="#10b981" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M128 493 L128 548 L116 548" stroke="#10b981" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M192 493 L192 548 L204 548" stroke="#10b981" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />

                  {/* Ground Level Civil Concrete Boundary */}
                  <line x1="45" y1="505" x2="275" y2="505" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4 4" />
                  <text x="10" y="510" fontSize="9" fontWeight="bold" fill="currentColor">G.L. Ground Level</text>
                  <text x="230" y="545" fontSize="9" fontWeight="bold" fill="#10b981">6–16x Anchor Bolts</text>
                </svg>
              </div>
                    ...
                    <table className="w-full text-left border-collapse text-xs">
                      <thead>
                        <tr className="bg-slate-900 text-white text-[11px] font-extrabold uppercase tracking-wider border-b border-slate-800">
                          <th className="py-2.5 px-3.5 sm:px-4 w-1/2">Flag Mast Structure</th>
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-zinc-800/80 font-medium text-slate-800 dark:text-slate-200">
                        {flagMastBlueprintSpecs.map((spec, idx) => (
                          <tr
                            key={spec.property}
                ...
                <div className="space-y-2.5 text-xs sm:text-sm">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Engineered from high-tensile steel to withstand high wind loads and demanding outdoor conditions, ensuring long-term structural durability.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Available in standard heights from 12 m to 50 m, with customized configurations available according to project requirements.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-ssil-red shrink-0" />
                      Seamless Welding &amp; Bending
                    </h4>
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Automated manufacturing processes provide uniform finish, structural integrity, and a clean appearance suitable for high-visibility installations.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Protected with hot-dip galvanizing and optional powder coating or PU paint for enhanced corrosion resistance and long outdoor service life.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-2.5 text-xs sm:text-sm">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Engineered to withstand high wind speeds according to applicable structural requirements, making them suitable for coastal, industrial, institutional, and high-altitude environments.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Available with internal or external hoisting mechanisms, including manual or motorized configurations, for smooth and secure flag raising and lowering.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Modular sections, base plates, anchor bolts, and access provisions enable efficient transportation, installation, inspection, and maintenance.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    <h4 className="font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-ssil-red shrink-0" />
                      Aviation &amp; Safety Accessories
                    </h4>
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Can be configured with suitable obstruction lighting, lightning protection, safety locks, and other accessories where required by the installation environment.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-2.5 text-xs sm:text-sm">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Built with high-strength steel and corrosion-resistant protective systems for extended outdoor performance in demanding climates.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Tall, sleek, customizable designs create a strong visual presence for national flags, institutional locations, corporate premises, and ceremonial installations.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Weather-resistant finishes and dependable hoisting systems reduce maintenance requirements and support reliable long-term operation.
                    </p>
                  </div>
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 pl-3 leading-relaxed">
                      Available in various heights, configurations, finishes, colors, hoisting systems, and accessories to suit architectural, municipal, institutional, or corporate requirements.
                    </p>
                  </div>
                </div>
              </div>
