...
export const catalogProducts: CatalogProduct[] = [
  {
    ...
    galleryImages: generateGallery("led-light", "LED Lighting System", 36),
  },
  {
    id: "cat-02",
    ...
    nightImage: "/images/products/homepage/product-01/night.png",
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("street-light", "LED Street Luminaire", 18),
  },
  {
    id: "cat-03",
    ...
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("dec-pole", "Decorative Pole Variant", 41),
  },
  {
    id: "cat-04",
    name: "Designer Pole",
    ...
    nightImage: "/images/products/homepage/product-02/night.png",
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("des-pole", "Architectural Designer Pole", 22),
  },
  {
    id: "cat-05",
    ...
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("bollard", "Landscape Pathway Bollard", 22),
  },
  {
    id: "cat-06",
  ...
  {
    id: "cat-07",
    name: "Bulkhead Pathway, Wallwasher & Inground Lighting",
    slug: "bulkhead-pathway-wallwasher-inground-lighting",
    designCount: 27,
    tagline: "Reliable pathway lighting built for everyday environments.",
    description:
      "Heavy-duty bulkhead pathway luminaires, architectural wallwashers, and inground accent lights built with impact-resistant polycarbonate diffusers and die-cast aluminum housings for stairwells, perimeter walls, and industrial corridors.",
    dayImage: "/images/products/homepage/product-06/day.png",
    nightImage: "/images/products/homepage/product-06/night.png",
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("bulkhead", "Architectural Pathway & Inground Luminaire", 27),
  },
  {
    id: "cat-08",
    name: "Octagonal Pole",
    ...
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("octagonal", "Galvanized Octagonal Steel Pole", 2),
  },
  {
    id: "cat-09",
    name: "High Mast",
    ...
    nightImage: "/images/products/homepage/product-05/night.png",
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("high-mast", "Monumental High Mast System", 4),
  },
  {
    id: "cat-10",
    name: "National Flag",
    ...
    galleryImages: [
      {
        id: "flag-mast-01",
        name: "Monumental High-Tensile Flag Mast System",
        dayImage: "/images/products/homepage/product-04/day.png",
        nightImage: "/images/products/homepage/product-04/night.png",
        specs: "High-Tensile Steel • Motorized Hoisting • Wind Load Tested",
      },
    ],
  },
  {
    ...
    nightImage: "/images/products/homepage/product-01/night.png",
    heroImage: "/products/products-hero.png",
    galleryImages: generateGallery("solar-plant", "Commercial Solar Array Installation", 2),
  },
  {
    id: "cat-12",
    name: "Solar Lighting",
