...
const fallbackProducts = [
  { id: "product-01", name: "LED Indoor Lights", slug: "led-indoor-lights", designCount: 36, tagline: "Efficient indoor illumination engineered for architectural and commercial spaces.", description: "High-efficiency LED indoor luminaires designed for commercial complexes, corporate offices, industrial facilities, and public infrastructure spaces.", dayImage: "/images/products/homepage/product-01/day.png", nightImage: "/images/products/homepage/product-01/night.png", order: 0, active: true },
  { id: "product-02", name: "LED Street Lights", slug: "led-street-lights", designCount: 24, tagline: "High-performance street lighting built for modern highways and municipal roads.", description: "Advanced LED street light systems engineered for municipal expressways, urban thoroughfares, and highway corridors.", dayImage: "/images/products/homepage/product-01/day.png", nightImage: "/images/products/homepage/product-01/night.png", order: 1, active: true },
  ...
  { id: "product-04", name: "Designer Poles", slug: "designer-poles", designCount: 28, tagline: "Distinctive contemporary pole design for landmark architectural environments.", description: "Custom-engineered designer poles featuring contemporary architectural geometries, hot-dip galvanization, and premium powder-coated finishes.", dayImage: "/images/products/homepage/product-02/day.png", nightImage: "/images/products/homepage/product-02/night.png", order: 3, active: true },
  { id: "product-05", name: "Octagonal Poles", slug: "octagonal-poles", designCount: 16, tagline: "Heavy-duty galvanized steel infrastructure engineered for dependable performance.", description: "Industrial octagonal steel poles manufactured from high-tensile steel sheets, hot-dip galvanized in-house for expressways and heavy infrastructure.", dayImage: "/images/products/homepage/product-05/day.png", nightImage: "/images/products/homepage/product-05/night.png", order: 4, active: true },
  ...
  { id: "product-13", name: "Solar Lights", slug: "solar-lights", designCount: 16, tagline: "Autonomous solar illumination for smart, sustainable outdoor spaces.", description: "Autonomous solar-powered LED street lights and standalone solar luminaires equipped with high-efficiency PV panels.", dayImage: "/images/products/homepage/product-01/day.png", nightImage: "/images/products/homepage/product-01/night.png", order: 12, active: true },
